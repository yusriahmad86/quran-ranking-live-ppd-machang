...
export default function RankingPage() {
  ...
  async function loadRankings() {
    ...
    setRankings(data as LiveRankings);
    setError("");
    setLoading(false);
  }
          ...
          {overall.length > 0 ? (
            ...
            <div className="space-y-3">
              ...
              {overall.map((item) => {
                ...
                const level =
                  getLevel(item.current_page);

                const badge =
                  getLevelBadge(item.current_page);
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex shrink-0 items-center gap-3">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="mt-1 text-[10px] font-bold tracking-wide text-yellow-400">
                            {level}
                          </span>
                        ...
                        <p className="whitespace-nowrap font-black text-emerald-400">
